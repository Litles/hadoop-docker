...
echo -e "192.168.3.168\tnode-mysql" >> /etc/hosts
...
# ---- Spark Yarn Shuffle jar file ---
for HOST in node-worker1 node-worker2 node-worker3
do
  scp $HADOOP_HOME/share/hadoop/yarn/lib/spark*.jar root@$HOST:$HADOOP_HOME/share/hadoop/yarn/lib/;
done
